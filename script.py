...
# Создадим финальную версию match_data с историей действий для Undo
match_data_final = '''"""
...
with open('match_data.py', 'w', encoding='utf-8') as f:
    f.write(match_data_final)

print("✓ Создан файл: match_data.py")
print("  - Добавлена система отмены действий (Undo)")
print("  - История последних 20 действий")
print("  - Метод undo_last_action()")
